...
Original file is located at
    https://colab.research.google.com/drive/1RIwKU3rzl_hlvkEsXwF56Vc2irvAAPuZ
"""
...
def visualize_ranked_results(
    distmat, dataset, data_type, width=256, height=256, save_dir='', topk=5
):
